    ...
    return (
        <div className={s.sideblock}>
            ...
            <div className={s.upper_container}>
                <NavLink
                    className={navData => navData.isActive ? `${s.sidebar__link__active} ${s.sidebar__link}` : s.sidebar__link}
                    to="/timetable">
            ...
            <div className={s.upper_container}>
                <NavLink
                    className={navData => navData.isActive || isReservationActive ? `${s.sidebar__link__active} ${s.sidebar__link}` : s.sidebar__link}
                    to="/teachlist">
