    ...
    return (
        <>
            ...
            {userRole === "professor" ?
                ...
                >
                    <Spin spinning={isFetching} size="large" wrapperClassName={s.spin_teacher_cabinet}>
                        <div className={`ant-spin-container ${s.customSpinContainer}`}>
                            <div className={s.inner_block}>
                                <div className={`${s.avaname} ${s.radblock} ${s.first_inner_block}`}>
                                    {photo !== null ? <img className={s.user_img} src={photo} alt=""/> :
                                        <img src={userava} alt=""/>}
                                ...
                                <div className={`${s.persdata} ${s.radblock} ${s.second_inner_block}`}>
                                    ...
                                    />
                                    {errors.firstName &&
                                        <div className={s.npt_txt_span}>{errors.firstName.message}</div>}
                                ...
                                <div className={`${s.secondata} ${s.radblock}`}>
                                    ...
                                    <input {...register("experience", {required: "Это поле обязательное!"})}
                                        ...
                                        // onChange={(e) => props.setLocation(e.currentTarget.value)}
                                           ...
                                           disabled={isInputDisabled}/>
                                    {errors.experience &&
                                        <div className={s.npt_txt_span}>{errors.experience.message}</div>}
                                </div>
                            </div>
