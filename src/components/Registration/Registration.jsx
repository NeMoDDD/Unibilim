    ...
    <>
      <div className="reg-block">
        ...
        <div class="form-check">
          ...
          Я прочитал (а) правила и условия платформы и соглашаюсь на обработку персональных данных и Политику конфиденциальности
          </label>
        </div>
        <button type="submit" className="reg-end">Продолжить</button>
      </div>
    </>
  );
};
