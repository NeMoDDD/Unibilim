    ...
    <>
      ...
      <div className="reser_block">
        ...
        <div className="reser_table">
          ...
          <p className="txt_18" style={{marginTop:"-15px"}}>Понедельник, среда, пятница, суббота, воскресенье</p>
          <p className="subj_costet">Время занятий</p>
          <p className="txt_18" style={{marginTop:"-15px"}}>Пн,ср,пт - с 14:00 до 18:00 Сб,вс - с 12:00 до 21:00</p>
        <Table/>
        </div>
        <div className="table"></div>
        <div className="pay_block">
          <p className="txt" style={{marginLeft:"0px"}}>Рассчёт</p>
          ...
          <div className="for_pay">
            <p className="subj_costet" style={{color:"white"}}>Итоговая стоимость</p>
            <p className="costet" style={{color:"white"}}>450 сом</p>
